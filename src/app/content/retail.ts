 ...
 *                 right; match sticks got the same bump twice more
 *                 (42→48→54) once new box photos replaced the old ones — a
 *                 new product's fill should slot into this table by its own
 *                 real size, not default to a number here.
 *
